        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title">Editar Usuario: <span class="text-success"><?=$user['name']?> <?=$user['last_name']?></span></h3>
                            <p>Administre los usuarios que podrán administrar la plataforma.</p>
                            <br>
                            <form class="floating-labels" method="post" action="<?=base_url()?>admin/usuarios/<?=$user['id']?>/update" enctype="multipart/form-data">
                                <div class="form-group m-b-40">
                                    <input type="text" class="form-control" name="name" id="name" value="<?=$user['name']?>" required><span class="highlight"></span> <span class="bar"></span>
                                    <label for="name">Nombre</label>
                                </div>
                                <div class="form-group m-b-40">
                                    <input type="text" class="form-control" name="last_name" id="last_name" value="<?=$user['last_name']?>" required><span class="highlight"></span> <span class="bar"></span>
                                    <label for="last_name">Apellido</label>
                                </div>
                                <div class="form-group m-b-40">
                                    <input type="email" class="form-control" name="email" id="email" value="<?=$user['email']?>" required><span class="highlight"></span> <span class="bar"></span>
                                ...
                                <div class="block text-center mb-xl-4">
                                    <input name="submit" type="submit" value="Modificar Usuario" class="fcbtn btn btn-success btn-outline btn-1d">
